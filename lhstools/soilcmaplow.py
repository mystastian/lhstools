...
class SoilCMapLow(Benchmark):
    ...
    def __init__(self,config_name='config.ini',init=False,*args,**kwargs):
        ...
        super(SoilCMapLow,self).__init__(config_name,init,*args,**kwargs)
        #FAPAR parameters,
        super(SoilCMapLow,self).import_config(config_name,'SoilCMap')
