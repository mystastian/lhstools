...
class Uptake80(Benchmark):
    """Global Uptake 1980-80"""
    ...
    def get_sim(self,memberid):
        ...
        totc=Benchmark.read_ascii(self,fnmember)['Total']
        #average over whole simulated period...
        uptake=pd.Series(index=['1980-1989'])
    ...
    def plot_hist(self):
        ...
        uptake.transpose()['1980-1989'].plot(kind='kde',label='KDE',ax=ax[0],bw_method=0.5,color='lightblue')
        ax[0].plot([self.obs['1980-1989'],self.obs['1980-1989']],ax[0].get_ylim(),color='red',linewidth=2,label='IPCC')
        ax[0].axvspan(self.obs['1980-1989']-self.sigma_obs,self.obs['1980-1989']+self.sigma_obs,color='red',alpha=0.3,label=r'IPCC $\pm \sigma$')
